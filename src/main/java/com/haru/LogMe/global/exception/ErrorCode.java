...
public enum ErrorCode {
    ...
    // === AI 리포트 (AI Report) ===
    AI_REPORT_NOT_FOUND(HttpStatus.NOT_FOUND, "R001", "해당 AI 리포트를 찾을 수 없습니다."),
    AI_REPORT_GENERATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "R002", "AI 리포트 생성 중 오류가 발생했습니다.");
